...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/0utl1er-tech/phox-customer/gen/pb/search/v1"
	http "net/http"
	strings "strings"
)
...
// period.
const (
	// SearchServiceSearchCustomersProcedure is the fully-qualified name of the SearchService's
	// SearchCustomers RPC.
	SearchServiceSearchCustomersProcedure = "/search.v1.SearchService/SearchCustomers"
)
...
func NewSearchServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SearchServiceClient {
	...
	return &searchServiceClient{
		searchCustomers: connect.NewClient[v1.SearchCustomersRequest, v1.SearchCustomersResponse](
			httpClient,
			baseURL+SearchServiceSearchCustomersProcedure,
			connect.WithSchema(searchServiceMethods.ByName("SearchCustomers")),
...
// SearchCustomers calls search.v1.SearchService.SearchCustomers.
func (c *searchServiceClient) SearchCustomers(ctx context.Context, req *connect.Request[v1.SearchCustomersRequest]) (*connect.Response[v1.SearchCustomersResponse], error) {
...
func NewSearchServiceHandler(svc SearchServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	searchServiceMethods := v1.File_search_v1_search_proto.Services().ByName("SearchService").Methods()
	searchServiceSearchCustomersHandler := connect.NewUnaryHandler(
		SearchServiceSearchCustomersProcedure,
		svc.SearchCustomers,
		connect.WithSchema(searchServiceMethods.ByName("SearchCustomers")),
	...
	return "/search.v1.SearchService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case SearchServiceSearchCustomersProcedure:
			searchServiceSearchCustomersHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedSearchServiceHandler) SearchCustomers(context.Context, *connect.Request[v1.SearchCustomersRequest]) (*connect.Response[v1.SearchCustomersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("search.v1.SearchService.SearchCustomers is not implemented"))
}
